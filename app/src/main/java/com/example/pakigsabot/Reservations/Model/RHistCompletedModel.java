...
//Model
public class RHistCompletedModel {
    ...
    public RHistCompletedModel() {
        //empty constructor needed
    }

    public RHistCompletedModel(String autoReserveID, String rStatus_default, String totalPax, String rName, String checkINDate,
                               String checkOUTDate, String checkINTime, String cust_ID, String estID, String estName,
                               String estEmailAddress, String custFName, String custLName,
                               String adultPax, String childPax, String infantPax, String petPax, String fee, String dateOfCompletion,
                               String notes) {
