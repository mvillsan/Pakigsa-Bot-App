...
public class SalonReserveService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salon_reserve_service);
        ...
        reserveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notes.isEmpty() || reserveDateStr.isEmpty() || reserveTimeStr.isEmpty()) {
                    Toast.makeText(SalonReserveService.this, "You MUST input ALL Fields", Toast.LENGTH_SHORT).show();
                }else{
                    checkDuplicateTime();
                }
            }
    ...
    private void displayReservationDate() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(SalonReserveService.this,
    ...
    private void displayReservationTime() {
        ...
        ArrayAdapter<String> timeSlotAdapter = new ArrayAdapter<String>(SalonReserveService.this,
        ...
        try {
            ...
            if (custSubStatus.equals("Free")) {
                if (cust_numReservations >= 3) {
                    Toast.makeText(SalonReserveService.this, "Susbcribe to Pakigsa-Bot Premium NOW, to Reserve More!", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(SalonReserveService.this, "Please Re-check your Reservation Details!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void saveReservationDB() {
       ...
       /* //Updating establishment's number of reservations::
        ...
        reservation.put("reserv_est_ID", "gWRVCCD27IPQRGlSg5sMlVKS6JY2");
        reservation.put("reserv_est_Name", "Salon De Rose");
        reservation.put("reserv_est_emailAdd", "salonderose22@gmail.com");
        ...
        Toast.makeText(SalonReserveService.this, "Reservation Request Sent", Toast.LENGTH_SHORT).show();
    }
