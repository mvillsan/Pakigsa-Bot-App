...
public class SalonAdapter extends RecyclerView.Adapter<SalonAdapter.MyViewHolder>{
    ...
    Context context;
    ArrayList<SalonModels> salonArrayList;
    ...
    public SalonAdapter(Context context, ArrayList<SalonModels> salonArrayList) {
    ...
    public SalonAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context).inflate(R.layout.salon_est_items,parent, false);
        return  new SalonAdapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(@NonNull SalonAdapter.MyViewHolder holder, int position) {
        ...
        SalonModels daecList = salonArrayList.get(position);
        ...
        holder.selectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), SalonDetails.class);
    ...
    public void filterList(List<SalonModels> filteredList){
        salonArrayList = (ArrayList<SalonModels>) filteredList;
