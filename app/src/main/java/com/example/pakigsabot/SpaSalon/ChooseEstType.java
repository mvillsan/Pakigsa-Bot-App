...
public class ChooseEstType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_est_type2);
        ...
        txt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SpaEstList.class);
    ...
    private void refs(){
        ...
        txt1 = findViewById(R.id.restoTxt);
        txt2 = findViewById(R.id. cafeTxt);
    }
