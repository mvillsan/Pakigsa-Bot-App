...
public class SalonEstList extends AppCompatActivity {
    ...
    ArrayList<SalonModels> arrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salon_est_list);
        ...
        arrayList = new ArrayList<SalonModels>();

        //initializing the adapter
        adapter = new SalonAdapter(SalonEstList.this, arrayList);
    ...
    private void getList(){
        ...
        fStore.collection("establishments")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        for(DocumentSnapshot doc : task.getResult()){
                            SalonModels daeList = new SalonModels(doc.getString("est_id"),
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SalonEstList.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void filter(String newText){
        List<SalonModels> filteredList = new ArrayList<>();
        for(SalonModels item : arrayList){
