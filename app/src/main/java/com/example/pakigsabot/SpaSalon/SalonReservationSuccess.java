...
public class SalonReservationSuccess extends AppCompatActivity {
    //Initialize Variables
    MeowBottomNavigation bottomNavigation;
    TextView gotoReservationTxt, gotoHelpCenterTxt, emailResortTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salon_reservation_success);
        ...
        emailResortTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                emailMessageScreen();
            }
    ...
    public void refs(){
        gotoReservationTxt = findViewById(R.id.cancellingTxt);
        gotoHelpCenterTxt = findViewById(R.id.goTohelpCenterTxt);
        emailResortTxt = findViewById(R.id.emailTxt);
    }
