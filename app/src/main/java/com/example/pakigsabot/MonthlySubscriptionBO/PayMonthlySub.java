package com.example.pakigsabot.MonthlySubscriptionBO;
...
import com.example.pakigsabot.SignInBO;
...
public class PayMonthlySub extends AppCompatActivity {
    ...
    private void homeScreen(){
        Intent intent = new Intent(getApplicationContext(), BottomNavigationBO.class);
