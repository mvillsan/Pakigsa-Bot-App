    ...
    private void savePassword(){
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                oldPass = value.getString("cust_password");
            }
        });
        ...
        if(currentPass.length() < 8){
            ...
            Toast.makeText(ChangePass.this, "Some fields are EMPTY.", Toast.LENGTH_SHORT).show();
        }else{
                ...
                if(currentPass.equals(oldPass)){
                    ...
                    user.updatePassword(confirmPass).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            edited.put("cust_password", confirmPass);
                            docRef.update(edited).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(ChangePass.this, "No Changes has been made", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        ...
                        Toast.makeText(ChangePass.this, "OLD Password is INCORRECT", Toast.LENGTH_SHORT).show();
                }
            }else{
