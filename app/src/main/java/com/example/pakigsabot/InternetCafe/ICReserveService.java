...
import com.example.pakigsabot.SpaSalon.SalonReservationSuccess;
...
public class ICReserveService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icreserve_service);
        ...
        reserveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notes.isEmpty() || reserveDateStr.isEmpty() || reserveTimeStr.isEmpty()) {
                    Toast.makeText(ICReserveService.this, "You MUST input ALL Fields", Toast.LENGTH_SHORT).show();
                }else{
                    checkDuplicateTime();
                }
            }
    ...
    private void getServiceDetails() {
        ...
        if (extra != null) {
            selProcId = extra.getString("servId");
            selProcName = extra.getString("servName");
            selProcRate = extra.getString("servRate");
            selProcImageUrl = extra.getString("servImgUrl");
            estId = extra.getString("estID");
        }
        //Display selected Salon Service Details:
    ...
    private void displayReservationDate() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(ICReserveService.this,
    ...
    private void displayReservationTime() {
        ...
        ArrayAdapter<String> timeSlotAdapter = new ArrayAdapter<String>(ICReserveService.this,
        ...
        try {
            ...
            if (custSubStatus.equals("Free")) {
                if (cust_numReservations >= 3) {
                    Toast.makeText(ICReserveService.this, "Susbcribe to Pakigsa-Bot Premium NOW, to Reserve More!", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ICReserveService.this, "Please Re-check your Reservation Details!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void saveReservationDB() {
        ...
        docRef.update(editedNumReservations).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ICReserveService.this, "No Changes has been made", Toast.LENGTH_SHORT).show();
            }
        });
       ...
       /* //Updating establishment's number of reservations::
        ...
        docuRef.update(editedNumReservationsEst).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SalonReserveService.this, "No Changes has been made", Toast.LENGTH_SHORT).show();
            }
        });*/
        ...
        reservation.put("reserv_est_ID", "MflSxh238yMbImIbvi263whkHo53");
        reservation.put("reserv_est_Name", "Game City");
        reservation.put("reserv_est_emailAdd", "gamecitycebu@gmail.com");
        ...
        Toast.makeText(ICReserveService.this, "Reservation Request Sent", Toast.LENGTH_SHORT).show();
    }

    private void success(){
        Intent intent = new Intent(getApplicationContext(), SalonReservationSuccess.class);
