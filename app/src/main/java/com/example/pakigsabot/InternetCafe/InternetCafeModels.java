...
public class InternetCafeModels {
    String est_id;
    String est_Name;
    String est_address;
    String est_image;
    ...
    public InternetCafeModels() {
    }

    public InternetCafeModels(String est_id, String est_Name, String est_address, String est_image, String est_phoneNum) {
        this.est_id = est_id;
