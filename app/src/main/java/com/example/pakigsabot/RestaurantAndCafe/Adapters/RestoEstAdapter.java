...
public class RestoEstAdapter extends RecyclerView.Adapter<RestoEstAdapter.MyViewHolder>{
    //creating variables for Context and ArrayList
    Context context;
    ArrayList<RestoEstModel> restoArrayList;
    ...
    public RestoEstAdapter() {
        //Empty constructor needed
    }

    public RestoEstAdapter(Context context, ArrayList<RestoEstModel> restoArrayList) {
    ...
    @NonNull
    @Override
    public RestoEstAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return  new RestoEstAdapter.MyViewHolder(itemView);
    }

    @SuppressLint("RecyclerView")
    @Override
    public void onBindViewHolder(@NonNull RestoEstAdapter.MyViewHolder holder, int position) {
        RestoEstModel list = restoArrayList.get(position);
    ...
    public void filterList(List<RestoEstModel> filteredList){
        restoArrayList = (ArrayList<RestoEstModel>) filteredList;
