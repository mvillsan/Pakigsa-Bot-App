...
public class CafeReserveDetails extends AppCompatActivity {
    ...
    List<String> listEstablishments, listCheckInDates, listCheckInTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cafe_reserve_details);
        ...
        dateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                ...
                if(date.equalsIgnoreCase(todayDateStr)){
                    Toast.makeText(CafeReserveDetails.this, "Reserve a Slot Ahead of Time!", Toast.LENGTH_SHORT).show();
                }else{
        ...
        reserveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notes.isEmpty() || reserveDateStr.isEmpty() || reserveTimeStr.isEmpty() || adultStr.isEmpty()
                    ...
                    Toast.makeText(CafeReserveDetails.this, "You MUST input ALL Fields", Toast.LENGTH_SHORT).show();
                }else{
                    checkAccountStats();
                }
            }
    ...
    private void cafeDetails() {
        Intent intent = new Intent(getApplicationContext(), CafeDetails.class);
    ...
    private void displayReservationDate() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(CafeReserveDetails.this,
    ...
    private void displayReservationTime() {
        ...
        ArrayAdapter<String> timeSlotAdapter = new ArrayAdapter<String>(CafeReserveDetails.this,
        ...
        try {
            ...
            if (custSubStatus.equals("Free")) {
                if (cust_numReservations >= 3) {
                    Toast.makeText(CafeReserveDetails.this, "Susbcribe to Pakigsa-Bot Premium NOW, to Reserve More!", Toast.LENGTH_SHORT).show();
                } else {
            ...
            Toast.makeText(CafeReserveDetails.this, "Please Re-check your Reservation Details!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void saveReservationDB() {
        ...
        docRef.update(editedNumReservations).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CafeReserveDetails.this, "No Changes has been made", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Toast.makeText(CafeReserveDetails.this, "Reservation Request Sent", Toast.LENGTH_SHORT).show();
    }
    private void success(){
        Intent intent = new Intent(getApplicationContext(), CafeReservationSuccess.class);
    ...
    private void displayPreOrder(){
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(CafeReserveDetails.this)
