...
public class RestoEstModel {
    ...
    public RestoEstModel() {
        //Empty constructor needed
    }

    public RestoEstModel(String est_id, String est_Name, String est_address, String est_image, String est_phoneNum,
