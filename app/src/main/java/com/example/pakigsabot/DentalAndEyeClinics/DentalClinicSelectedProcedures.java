...
public class DentalClinicSelectedProcedures extends AppCompatActivity {
        ...
        reserveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (notes.isEmpty() || reserveDateStr.isEmpty() || reserveTimeStr.isEmpty()) {
                    ...
                    Toast.makeText(DentalClinicSelectedProcedures.this, "Please select a date.", Toast.LENGTH_SHORT).show();
                } //Check if reserve date is date today
                else if(reserveDateStr.equalsIgnoreCase(todayDateStr)){
                    dateError.setError("");
                    dateError.setVisibility(View.VISIBLE);
                    Toast.makeText(DentalClinicSelectedProcedures.this, "Reserve a Slot Ahead of Time!", Toast.LENGTH_SHORT).show();
   ...
   private void getProcedureDetails() {
    ...
    public void saveReservationDB() {
        ...
        reservation.put("reserv_childPax", "");
        reservation.put("reserv_infantPax", "");
        reservation.put("reserv_petPax", "");
